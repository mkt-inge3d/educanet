...
export function TimelineLineaProgresoSidebar({
  containerSelector,
  hayActivo,
}: {
  ...
  useEffect(() => {
    ...
    const medir = () => {
      ...
      setAltura(
        ultimo.top + ultimo.height / 2 - (primero.top + primero.height / 2)
      );
    };
  ...
  return (
    <motion.div
      aria-hidden="true"
      className="pointer-events-none absolute left-[21px] top-0 w-[1.5px] -translate-x-1/2 bg-primary"
      initial={{ height: 0 }}
